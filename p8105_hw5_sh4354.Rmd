...
The sample average of μ̂ across tests for which the null is rejected is approximately equal to the true value of μ. This is because the sample is random, meaning it will result in approximately the same distribution as the true sample size. 
